...
latent_dim=256
model = tf.keras.models.load_model('./Enc_files/Encoder_Decoder_model_french_.h5')
...
exclamations=pickle.load(open('./Enc_files/exclamations.pickle','rb'))
questions=pickle.load(open('./Enc_files/questions.pickle','rb'))
